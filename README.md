# zama-commits-for-all
Complete your 10+ commits for zama guild task


## Step-by-Step Guide👇

### Go to https://github.com/new and create a New Repo, Make sure to set it public and Click Create Repository.

### After repo creation, click the <> Code button ( Green Colour)
Select: Open with Codespace → New codespace
As I already showed you how the codespace look in my previous video of OCTRA testnet.


### Now Scroll down and paste the Given command Below
```
...
```
 ...
 Close the windows and Verify the guild after 30-60 minutes
Done ✅
